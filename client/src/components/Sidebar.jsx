        ...
        >
            ...
            <nav className="mt-8">
                <ul>
                    ...
                    <li className="hover:bg-gray-700 p-4">
                        <Link to="/upload" className="flex items-center" onClick={toggleSidebar}>
                            <FaUpload className="mr-3" /> Upload Car
                        </Link>
                    </li>
                    <li className="hover:bg-gray-700 p-4">
                        <Link to="/view" className="flex items-center" onClick={toggleSidebar}>
                            <FaList className="mr-3" /> View Cars
                        </Link>
                    </li>
                    <li className="hover:bg-gray-700 p-4">
                        <Link to="/manage" className="flex items-center" onClick={toggleSidebar}>
